...
<div class="card info-card sales-card" style="background: url('{{ asset('front/img/lightcolour1.jpg') }}');background-size: cover;">
...
<!-- End Blog Count Card -->
    ...
    <!-- End Blog Count Card -->
      ...
      <!--Reports-->
            <div class="col-12">
              <div class="card">
                <div class="card-body" style="background: url('{{ asset('front/img/lightcolour3.webp') }}');background-size: cover;">
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body pb-0" style="background: url('{{ asset('front/img/lightcolour4.jpeg') }}');background-size: cover;">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body pb-0" style="background: url('{{ asset('front/img/lightcolour5.avif') }}');background-size: cover;">
