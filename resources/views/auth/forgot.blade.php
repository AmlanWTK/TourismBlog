...
<head>
  ...
  <title>{{ !empty($meta_title) ? $meta_title: 'Forgot' }}</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3" style="background: url('{{ asset('front/img/lightcolour3.webp') }}');background-size: cover;">
                ...
                <div class="card-body" >
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="color: #12372A;">Forgot Password</h5>
                    <p class="text-center small" style="color: #436850;">Enter your email to reset password</p>
                  </div>
                  ...
                  <div class="col-12">
                      <label for="email" class="form-label" style="color: #436850;">Your Email</label>
                      <input type="email" name="email" class="form-control" id="email" required>
                      <div class="invalid-feedback" style="color: #436850;">Please enter a valid Email adddress!</div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0"  style="color: #436850;margin-top: 20px;">Already have an account? <a href="{{ url('login') }}" style="color: #12372a;">Login</a></p>
