        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" style="background-color:#B0C4DE;">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="" method="post" enctype="multipart/form-data"> <!--image upload korar jnno -->
                {{csrf_field()}}
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  <label class="form-label" style="color:#002244;">Description</label>
                  <textarea class="form-control tinymce-editor" name="description"></textarea>
                </div>

                <div class="col-md-12">
                  <label class="form-label"  style="color:#002244;">Tags</label>
                ...
                <div class="col-md-6">
                  <label for="inputName5" class="form-label"  style="color:#002244;">Publish</label>
