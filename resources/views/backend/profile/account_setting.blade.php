          ...
          <div class="card">
            <div class="card-body" style="background: url('{{ asset('front/img/lightcolour.jpg') }}');background-size: cover;">
              ...
              <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-12">
                  <label class="form-label"  style="color:#002244;">Name</label>
                  <input type="text" class="form-control" value="{{ $getUser->name }}" name="name" required >
                </div>

                <div class="col-md-12">
                  <label class="form-label"  style="color:#002244;">Email</label>
                  <input type="email" readonly class="form-control" value="{{ $getUser->email }}">
                </div>


                <div class="col-md-6">
                  <label class="form-label"  style="color:#002244;">Profile</label>
                ...
                <!-- Extra part -->
                <div class="col-md-6">
                  <label class="form-label"  style="color:#002244;">Identity</label>
                  <input type="text" class="form-control" name="profile_identity" value="{{ $getUser->profile_identity }}" >
                </div>

                <div class="col-md-12">
                  <label class="form-label"  style="color:#002244;">Profile Description</label>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" style="background-color: #002244">Update Setting</button>
                </div>
